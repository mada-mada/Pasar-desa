...
<div class="flex justify-between items-center mb-6">
    <div>
        ...
        <p class="text-gray-500 mt-1">Kelola data pasar, lokasi GIS, dan fasilitas.</p>
    </div>
    <a href="{{ route('admin.pasar.create') }}" class="btn-blue px-4 py-2 rounded-lg font-medium shadow-lg flex items-center space-x-2">
