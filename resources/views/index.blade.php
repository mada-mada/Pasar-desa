...
@section('content')
    ...
    <section class="hero-gradient py-16 md:py-24 relative z-10">
        <div class="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div class="animate-fade-up inline-flex items-center justify-center gap-2 mb-5">
                ...
                <span
                    class="text-white/50 text-xs uppercase tracking-widest">{{ now()->translatedFormat('l, d F Y') }}</span>
            </div>
            ...
            <h1 class="animate-fade-up animate-fade-up-delay-1 font-black text-white leading-[1.1] tracking-tight mb-5"
                ...
                Temukan <span class="text-[#facc15] relative inline-block">
                    ...
                    <svg class="absolute -bottom-1 left-0 w-full" viewBox="0 0 200 8" fill="none"
                        ...
                        <path d="M2 6 Q50 2 100 6 Q150 10 198 6" stroke="#eab308" stroke-width="2.5" stroke-linecap="round"
            ...
            {{-- Subtitle --}}
            <p
                class="animate-fade-up animate-fade-up-delay-2 text-white/60 text-base md:text-lg max-w-2xl mx-auto mb-8 leading-relaxed">
                ...
                <form action="{{ route('pasar.index') }}" method="GET" role="search">
                    <div style="position:relative; display:flex; align-items:center;">
                        ...
                        <input type="text" name="search" id="search-input" value="{{ request('search') }}"
                            class="search-bar" placeholder="Cari nama pasar atau kecamatan..." autocomplete="off"
    ...
    {{-- ============================================
     ...
     ============================================ --}}
    <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 relative z-20 mb-4">
                ...
                @if (request('search'))
                    <p class="text-slate-500 mt-1.5 text-sm">
                        ...
                        <a href="{{ route('pasar.index') }}"
                            class="ml-2 text-xs text-slate-400 hover:text-slate-600 underline">Hapus filter</a>
                    </p>
                @endif
            </div>
